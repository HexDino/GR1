import { PrismaClient, MetricType, HealthGoalCategory, HealthGoalStatus, HealthGoalPriority, NotificationType } from '@prisma/client';
  ...
  if (existingGoals === 0) {
    ...
    const goalTemplates = [
      {
        ...
        category: HealthGoalCategory.WEIGHT,
        target: '70',
        unit: 'kg',
      ...
      },
      {
        ...
        category: HealthGoalCategory.EXERCISE,
        target: '30',
        unit: 'minutes',
      ...
      },
      {
        ...
        category: HealthGoalCategory.NUTRITION,
        target: '5',
        unit: 'servings',
        priority: HealthGoalPriority.MEDIUM
      },
      {
        ...
        category: HealthGoalCategory.SLEEP,
        target: '8',
        unit: 'hours',
        priority: HealthGoalPriority.HIGH
      },
      {
        ...
        category: HealthGoalCategory.MEDICATION,
        target: '100',
        unit: 'percent',
        priority: HealthGoalPriority.HIGH
      },
      {
        ...
        category: HealthGoalCategory.MENTAL_HEALTH,
        target: '15',
        unit: 'minutes',
        priority: HealthGoalPriority.MEDIUM
      }
    ...
    for (const patient of patients) {
      ...
      for (const goalTemplate of selectedGoals) {
        ...
        let status: HealthGoalStatus = HealthGoalStatus.ACTIVE;
        if (progress >= 95) status = HealthGoalStatus.COMPLETED;
        else if (deadline < new Date()) status = HealthGoalStatus.OVERDUE;
